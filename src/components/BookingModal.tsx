          ...
          <div className="relative w-full max-w-lg rounded-2xl border bg-white p-6 shadow-2xl md:p-8" style={{ maxHeight: "90vh", overflowY: "auto" }} onClick={(e) => e.stopPropagation()}>
            ...
            {done ? (
              <div className="py-12 text-center">
                <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full text-3xl" style={{ backgroundColor: "oklch(55% 0.12 190 / 0.1)" }}>✅</div>
              ...
              <>
                ...
                {date && (
                  <div className="mb-4 rounded-xl p-3 text-center text-sm" style={{ backgroundColor: "oklch(55% 0.12 190 / 0.08)" }}>
