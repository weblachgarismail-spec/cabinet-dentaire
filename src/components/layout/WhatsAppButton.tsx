  ...
  return (
    <>
      <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
        ...
        <button
          ref={btnRef}
          className="flex items-center gap-2 rounded-full px-5 py-3 shadow-lg transition-transform hover:scale-105"
        ...
        >
          ...
          <span className="text-sm font-semibold text-white">Prendre RDV &gt;</span>
        </button>
      </div>
